...
if __name__ == "__main__":
    ...
    worker = PyTorchWorker(run_id='0', nameserver='127.0.0.1')
    worker.run(background=True)

    bohb = BOHB(configspace=worker.get_configspace(), run_id='0', nameserver='127.0.0.1', min_budget=9, max_budget=243)
    bohb.run(n_iterations=4)
